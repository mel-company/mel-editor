...
// Categories 1: Grid
export const CategoriesSection = ({ categories }: { categories: CategoryType[] }) => {
...
export const CategoriesSection2 = ({ categories, content }: { categories: CategoryType[]; content?: { title?: string } }) => {
    if (!categories || categories.length === 0) {
        return (
            <div className="container mx-auto px-4 py-12">
                {content?.title && (
...
export const CategoriesSection3 = ({ categories, content }: { categories: CategoryType[]; content?: { title?: string } }) => {
    if (!categories || categories.length === 0) {
        return (
            <div className="container mx-auto px-4 py-12">
                {content?.title && (
...
export const CategoriesSection4 = ({ categories, content }: { categories: CategoryType[]; content?: { title?: string } }) => {
    if (!categories || categories.length === 0) {
        return (
            <div className="container mx-auto px-4 py-12">
                {content?.title && (
...
export const CategoriesSection5 = ({ categories, content }: { categories: CategoryType[]; content?: { title?: string } }) => {
    if (!categories || categories.length === 0) {
        return (
            <div className="container mx-auto px-4 py-12">
                {content?.title && (
