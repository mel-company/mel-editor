  ...
  return (
    <header className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 min-h-[60vh] sm:min-h-[70vh] flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-8 md:gap-12">
      ...
      <div className="flex-1 w-full max-w-lg relative">
        <img
          src={photoUrl || ""}
          className={`w-full rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl object-cover ${photoUrl ? "h-auto" : "h-64 sm:h-80 md:h-96 opacity-0"
            }`}
          alt={title || "Hero"}
          data-type="image"
        ...
        />
        {!photoUrl && (
          <div className="absolute inset-0 bg-slate-200 rounded-xl sm:rounded-2xl flex items-center justify-center">
  ...
  return (
    <header className="relative w-full min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={photoUrl || ""}
          className={`w-full h-full object-cover ${photoUrl ? "" : "opacity-0"
            }`}
          alt={title || "Hero"}
          data-type="image"
  ...
  return (
    <header className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 min-h-[60vh] sm:min-h-[70vh] grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
      ...
      <div className="w-full relative">
        <img
          src={photoUrl || ""}
          className={`w-full rounded-2xl shadow-2xl object-cover ${photoUrl ? "h-auto" : "h-64 sm:h-80 md:h-96 opacity-0"
            }`}
          alt={title || "Hero"}
          data-type="image"
