...
export const inspired_sections: SectionOptionType[] = [
  {
    id: "1",
    title: "Inspired by Organic Knowledge",
    description: "Traditional knowledge section with natural ingredients",
    component: "InspiredByOrganic1",
    thumbnail: {
