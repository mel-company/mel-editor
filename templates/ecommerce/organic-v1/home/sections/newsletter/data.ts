...
export const newsletter_sections: SectionOptionType[] = [
    {
        id: "1",
        title: "Newsletter - Organic Subscribe",
        description: "قسم الاشتراك بالنشرة البريدية العضوي",
        component: "NewsletterOrganic1",
        thumbnail: {
