...
import { downloadJSON, exportToJSON } from "../../../../shared/utils/export";
import { convertEditorToApiFormat } from "../../../../shared/utils/template-to-api";
      ...
      <button
        onClick={async () => {
          try {
            ...
            const { generateProjectZip } = await import("../../../../shared/utils/project-exporter");
